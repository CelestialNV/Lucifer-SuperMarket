...
<nav class="navbar navbar-expand-lg navbar-dark bg-black">
  <div class="container-fluid">
    <a class="navbar-brand text-warning" href="VendorUpdate.php">Lucifer</a>
...
<div class="card card-outline-secondary w-90" >
             ...
             <?php if(isset($_GET['error'])){?>
                        ...
                        <?php if(isset($_GET['error1'])){?>
                          <div class="alert alert-danger">
                          <audio id="sound2" src="../../dialogues/PhiliaUpdateVendor1.mp3" preload="auto"></audio>
                        ...
                        <form class="row g-3" method="post" action="Controls/UpdateVendor.php">
					  ...
					  <div class="col-12">					  
					  <button type="submit" id="UpdateVendor" name="UpdateVendor" class="btn btn-outline-warning">Update Vendor</button>
					  <button type="reset" class="btn">Clear</button>
            <audio id="sound1" src="../../dialogues/PhiliaUpdateVendor.mp3" preload="auto"></audio>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <center> <image src="../../Hostes/Philia.png" class="img-responsive" width="100" height="100">
              <p>You can't update a none existing vendor. Please check the list of vendors in the vendor search table.
              </p>
          </center>
...
<div class="modal fade" id="PhiliaM1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <center> <image src="../../Hostes/Philia.png" class="img-responsive" width="100" height="100">
              <p>This is the vendor add form. You only need the vendor ID to identify the vendor you want to change. You 
                can always check vendor IDs in the vendor search table.
              </p>
          </center>
