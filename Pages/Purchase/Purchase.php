...
<nav class="navbar navbar-expand-lg navbar-dark bg-black">
  <div class="container-fluid">
    <a class="navbar-brand text-warning" href="Purchase.php">Lucifer</a>
...
<div class="card card-outline-secondary w-90" >
				 <div class="card-header">Purchse</div>
				  <div class="card-body">
             <?php if(isset($_GET['error'])){?>
                        ...
                        <?php if(isset($_GET['error1'])){?>
                          <div class="alert alert-danger">
                          <audio id="sound2" src="../../dialogues/GouhriAddPurchase1.mp3" preload="auto"></audio>
                        <p type="button"  data-bs-toggle="modal" data-bs-target="#GouhriM1" onclick="document.getElementById('sound2').play()";>Product doesn't exist</p></div><?php }?>
                        <?php if(isset($_GET['success'])){?>
                          <div class="alert alert-success">
                        <p class="error"> <?php echo $_GET['success']; ?></p></div>  <?php }?>
                        <form class="row g-3" action="Controls/AddPurchase.php" method="post" >
                      <div class="form-group col-md-3">
                        <label for="PurchaseDate">Purchase Date</label>
                        <input type="date" class="form-control datepicker" id="PurchaseDate" name="PurchaseDate">
                      </div>
                              <div class="form-group col-md-2">
                               <label for="ProductName">Product Name</label>
                               <input type="text" class="form-control invTooltip" id="ProductName" name="ProductName" required>
                              </div>
                              <div class="form-group col-md-3">
								              <label for="VendorName">Vendor Name</label>
                              <?php 
                              require_once "Controls/FetchVendor.php";?>
                              <select class="form-select" aria-label="Default select example" name="VendorName" id="VendorName" required>
                    ...
                    <div class="col-12">
                    <button type="submit" id="addPurchase" name="addPurchase"class="btn btn-outline-warning">Add Purchase</button>
                    <button type="reset" class="btn">Clear</button>
                    <audio id="sound1" src="../../dialogues/GouhriAddPurchase.mp3" preload="auto"></audio>
                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#GouhriM" onclick="document.getElementById('sound1').play()";>
                      Need Help ?
                    </button>  
                    </div>
                  </form><!--Purchaase form end-->
                </div>
            </div>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <center> <image src="../../Hostes/Gouhri.png" class="img-responsive" width="100" height="100">
              <p>This is the add purchase form. Enter the product that has been purchased along with the vendor
...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <center> <image src="../../Hostes/Gouhri.png" class="img-responsive" width="100" height="100">
              <p>The product you entered doesn't exist. Please check the product search table.
              </p>
          </center>
