...
<div class="card card-outline-secondary w-90" >
             ...
             <?php if(isset($_GET['error'])){?>
                        ...
                        <?php if(isset($_GET['error1'])){?>
                         <div class="alert alert-danger">
                         <audio id="sound2" src="../../dialogues/ArkAddProduct1.mp3" preload="auto"></audio>
                        <p type="button"  data-bs-toggle="modal" data-bs-target="#ArkM" onclick="document.getElementById('sound2').play()";>Product Already Exists</p></div><?php }?>
                        <?php if(isset($_GET['success'])){?>
                          <div class="alert alert-success">
                        <p class="error"> <?php echo $_GET['success']; ?></p></div>  <?php }?>
                        <form class="row g-3" action="Controls/AddProduct.php" method="post"><!--Product Form beginning-->
								<div class="form-group col-md-3">
								  <label for="ProductNum">Product Number</label>
								  <input type="text" class="form-control" name="ProductNum" id="ProductNum" autocomplete="off" required>
								</div>
                <div class="form-group col-md-3">
								  <label for="ProductBrand">Brand</label>
                  <?php 
                   require_once "Controls/FetchBrand.php";?>
                   <select class="form-select" aria-label="Default select example" name="ProductBrand" id="ProductBrand" required>
            ...
            <?php endwhile;?>
                ...
                <div class="form-group col-md-3">
                        ...
                        <input type="date" class="form-control datepicker" id="ExpirationDate" name="ExpirationDate">
                      </div>
							  <div class="form-row">
								  <div class="form-group col-md-3">
							  ...
							  <div class="form-row">
								<div class="form-group col-md-6">
								  <textarea rows="4" class="form-control" placeholder="Description" name="Description" id="Description"></textarea>
								</div>
							  </div>
							  <br>
								<div class="form-group col-md-3">
								  <label for="Discount">Discount %</label>
								  <input type="number" class="form-control" value="0" name="Discount" id="Discount" min="0" max="100" required>
								</div>
								<div class="form-group col-md-3">
								  <label for="Stock">Amount</label>
								  <input type="number" class="form-control" value="1" name="Stock" id="Stock" min="1" required>
								</div>
								<div class="form-group col-md-3">
								  <label for="UnitPrice">Unit Price</label>
								  <input type="text" class="form-control" value="0" name="UnitPrice" id="UnitPrice" required>
								</div>
							  <div class="col-12"><!--add poppup here-->
							  <button type="submit" id="addProduct"  name="addProduct" class="btn btn-outline-warning">Add Product</button>
							  <button type="reset" class="btn" id="itemClear">Clear</button>
                <audio id="sound1" src="../../dialogues/ArkAddProduct.mp3" preload="auto"></audio>
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#ArkM1" onclick="document.getElementById('sound1').play()" >
                  Need Help ?     
                </button>
							  </div>
		             </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <center> <image src="../../Hostes/Ark.png" class="img-responsive" width="100" height="100">
              <p>Hello I am Ark and I'm here to assist you.
                First of all, you need to provide the System 
                with a product name. It could be whatever you 
                like, just something You would remember.
                the Description is optionnal, same goes for 
                the Discount. if any errors show up, click on it
                to call me.
              </p>
          </center>
...
<div class="modal fade" id="ArkM" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <center> <image src="../../Hostes/Ark.png" class="img-responsive" width="100" height="100">
              <p>you have already added this product. if it doesn't 
                show up in the search section, try refreshing the page.
              </p>
          </center>
