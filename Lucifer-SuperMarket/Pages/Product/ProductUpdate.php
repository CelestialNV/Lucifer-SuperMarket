...
<nav class="navbar navbar-expand-lg navbar-dark bg-black">
  <div class="container-fluid">
    <a class="navbar-brand text-warning" href="ProductUpdate.php">Lucifer</a>
...
<div class="card card-outline-secondary w-90" >
             ...
             <?php if(isset($_GET['error'])){?>
                        ...
                        <?php if(isset($_GET['error1'])){?>
                          <div class="alert alert-danger">
                          <audio id="sound2" src="../../dialogues/ArkUpdateProduct1.mp3" preload="auto"></audio>
                        <p type="button"  data-bs-toggle="modal" data-bs-target="#ArkM" onclick="document.getElementById('sound2').play()";>Product Doesn't Exist</p></div><?php }?>
                        <?php if(isset($_GET['success'])){?>
                          <div class="alert alert-success">
                        <p class="error"> <?php echo $_GET['success']; ?></p></div>  <?php }?>
             <form class="row g-3" action="Controls/UpdateProduct.php" method="post"><!--Product Form beginning-->
							  ...
							  <button type="submit" id="updateProduct"  name="updateProduct" class="btn btn-outline-warning">Update Item</button>
							  <button type="reset" class="btn" id="itemClear">Clear</button>
                <audio id="sound1" src="../../dialogues/ArkUpdateProduct.mp3" preload="auto"></audio>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <center> <image src="../../Hostes/Ark.png" class="img-responsive" width="100" height="100">
              <p>To update a product, Enter the product ID and the rest of the information your want to change.
...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <center> <image src="../../Hostes/Ark.png" class="img-responsive" width="100" height="100">
              <p>The product ID you entered doesn't exist. Please check the search product table.
              </p>
          </center>
